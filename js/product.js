...
function setItemsInHtml(){
  ...
  for (let i = 0; i < products.length; i++) {
    ...
    <div class="card">
                ...
                <button onclick="creat(${i})">Add To Cart</button>
            </div>
    `
  }
...
function display(){
  ...
  for (let i = 0; i < shopping.length; i++) {
    ...
    <img src="${shopping[i].img}" alt="">
                ...
                <div class="count">
                <i class="bi bi-plus" id="plus" onclick='plusMinus(${shopping[i].amount + 1} , ${i})'></i>
                <span>${shopping[i].amount}</span>
                <i class="bi bi-dash id="minus" onclick='plusMinus(${shopping[i].amount - 1} , ${i})'"></i>
                </div>
